...
struct IDiscordUserManager {
  enum EDiscordResult(DISCORD_API* get_current_user)(
      struct IDiscordUserManager* manager, struct DiscordUser* current_user);
  void(DISCORD_API* get_user)(
  ...
  enum EDiscordResult(DISCORD_API* current_user_has_flag)(
...
struct IDiscordActivityEvents {
  ...
  void(DISCORD_API* on_activity_join_request)(void* event_data,
                                              struct DiscordUser* user);
...
struct IDiscordActivityManager {
  ...
  void(DISCORD_API* send_request_reply)(
      ...
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  void(DISCORD_API* send_invite)(
      struct IDiscordActivityManager* manager, DiscordUserId user_id,
      enum EDiscordActivityActionType type, const char* content,
      void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  void(DISCORD_API* accept_invite)(
      struct IDiscordActivityManager* manager, DiscordUserId user_id,
      void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
...
struct IDiscordLobbyEvents {
  ...
  void(DISCORD_API* on_lobby_delete)(void* event_data, int64_t lobby_id,
                                     uint32_t reason);
  void(DISCORD_API* on_member_connect)(void* event_data, int64_t lobby_id,
                                       int64_t user_id);
  void(DISCORD_API* on_member_update)(void* event_data, int64_t lobby_id,
                                      int64_t user_id);
  void(DISCORD_API* on_member_disconnect)(void* event_data, int64_t lobby_id,
                                          int64_t user_id);
  void(DISCORD_API* on_lobby_message)(void* event_data, int64_t lobby_id,
                                      int64_t user_id, uint8_t* data,
                                      uint32_t data_length);
  void(DISCORD_API* on_speaking)(void* event_data, int64_t lobby_id,
                                 int64_t user_id, bool speaking);
  void(DISCORD_API* on_network_message)(void* event_data, int64_t lobby_id,
...
struct IDiscordLobbyManager {
  ...
  void(DISCORD_API* create_lobby)(
      struct IDiscordLobbyManager* manager,
      struct IDiscordLobbyTransaction* transaction, void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result,
                                  struct DiscordLobby* lobby));
  void(DISCORD_API* update_lobby)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
      struct IDiscordLobbyTransaction* transaction, void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  void(DISCORD_API* delete_lobby)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
      void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  void(DISCORD_API* connect_lobby)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
  ...
  void(DISCORD_API* connect_lobby_with_activity_secret)(
      struct IDiscordLobbyManager* manager, DiscordLobbySecret activity_secret,
      void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result,
                                  struct DiscordLobby* lobby));
  void(DISCORD_API* disconnect_lobby)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
      void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  enum EDiscordResult(DISCORD_API* get_lobby)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
      struct DiscordLobby* lobby);
  ...
  enum EDiscordResult(DISCORD_API* lobby_metadata_count)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
      int32_t* count);
  enum EDiscordResult(DISCORD_API* member_count)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
      int32_t* count);
  enum EDiscordResult(DISCORD_API* get_member_user_id)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
      int32_t index, DiscordUserId* user_id);
  enum EDiscordResult(DISCORD_API* get_member_user)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
  ...
  void(DISCORD_API* lobby_count)(struct IDiscordLobbyManager* manager,
                                 int32_t* count);
  enum EDiscordResult(DISCORD_API* get_lobby_id)(
      struct IDiscordLobbyManager* manager, int32_t index,
      DiscordLobbyId* lobby_id);
  void(DISCORD_API* connect_voice)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
      void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  void(DISCORD_API* disconnect_voice)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
      void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  enum EDiscordResult(DISCORD_API* connect_network)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id);
  enum EDiscordResult(DISCORD_API* disconnect_network)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id);
  enum EDiscordResult(DISCORD_API* flush_network)(
      struct IDiscordLobbyManager* manager);
  enum EDiscordResult(DISCORD_API* open_network_channel)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
      uint8_t channel_id, bool reliable);
  enum EDiscordResult(DISCORD_API* send_network_message)(
      struct IDiscordLobbyManager* manager, DiscordLobbyId lobby_id,
...
struct IDiscordNetworkEvents {
  void(DISCORD_API* on_message)(void* event_data, DiscordNetworkPeerId peer_id,
...
struct IDiscordNetworkManager {
   ...
   */
  enum EDiscordResult(DISCORD_API* flush)(
      struct IDiscordNetworkManager* manager);
  /**
   * Open a connection to a remote peer.
   */
  enum EDiscordResult(DISCORD_API* open_peer)(
      struct IDiscordNetworkManager* manager, DiscordNetworkPeerId peer_id,
      const char* route_data);
  /**
   * Update the route data for a connected peer.
   */
  enum EDiscordResult(DISCORD_API* update_peer)(
      struct IDiscordNetworkManager* manager, DiscordNetworkPeerId peer_id,
      const char* route_data);
  /**
   * Close the connection to a remote peer.
   */
  enum EDiscordResult(DISCORD_API* close_peer)(
      struct IDiscordNetworkManager* manager, DiscordNetworkPeerId peer_id);
  /**
   * Open a message channel to a connected peer.
   */
  enum EDiscordResult(DISCORD_API* open_channel)(
      struct IDiscordNetworkManager* manager, DiscordNetworkPeerId peer_id,
      DiscordNetworkChannelId channel_id, bool reliable);
  /**
   * Close a message channel to a connected peer.
   */
  enum EDiscordResult(DISCORD_API* close_channel)(
      struct IDiscordNetworkManager* manager, DiscordNetworkPeerId peer_id,
      DiscordNetworkChannelId channel_id);
  /**
   * Send a message to a connected peer over an opened message channel.
   */
  enum EDiscordResult(DISCORD_API* send_message)(
      struct IDiscordNetworkManager* manager, DiscordNetworkPeerId peer_id,
...
struct IDiscordOverlayManager {
  ...
  void(DISCORD_API* is_locked)(struct IDiscordOverlayManager* manager,
                               bool* locked);
  void(DISCORD_API* set_locked)(
      struct IDiscordOverlayManager* manager, bool locked, void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  void(DISCORD_API* open_activity_invite)(
      ...
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  void(DISCORD_API* open_guild_invite)(
      struct IDiscordOverlayManager* manager, const char* code,
      void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  void(DISCORD_API* open_voice_settings)(
      struct IDiscordOverlayManager* manager, void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  enum EDiscordResult(DISCORD_API* init_drawing_dxgi)(
      struct IDiscordOverlayManager* manager, IDXGISwapChain* swapchain,
  ...
  void(DISCORD_API* mouse_button_event)(struct IDiscordOverlayManager* manager,
                                        uint8_t down, int32_t click_count,
  ...
  void(DISCORD_API* ime_cancel_composition)(
      struct IDiscordOverlayManager* manager);
  void(DISCORD_API* set_ime_composition_range_callback)(
      ...
      void(DISCORD_API* on_ime_composition_range_changed)(
          void* on_ime_composition_range_changed_data, int32_t from, int32_t to,
          struct DiscordRect* bounds, uint32_t bounds_length));
  void(DISCORD_API* set_ime_selection_bounds_callback)(
      ...
      void(DISCORD_API* on_ime_selection_bounds_changed)(
          void* on_ime_selection_bounds_changed_data, struct DiscordRect anchor,
          struct DiscordRect focus, bool is_anchor_first));
  bool(DISCORD_API* is_point_inside_click_zone)(
      struct IDiscordOverlayManager* manager, int32_t x, int32_t y);
};
...
struct IDiscordStorageManager {
  ...
  void(DISCORD_API* read_async)(
      struct IDiscordStorageManager* manager, const char* name,
      void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result, uint8_t* data,
                                  uint32_t data_length));
  void(DISCORD_API* read_async_partial)(
      struct IDiscordStorageManager* manager, const char* name, uint64_t offset,
      uint64_t length, void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result, uint8_t* data,
                                  uint32_t data_length));
  enum EDiscordResult(DISCORD_API* write)(
      struct IDiscordStorageManager* manager, const char* name, uint8_t* data,
      uint32_t data_length);
  void(DISCORD_API* write_async)(
      struct IDiscordStorageManager* manager, const char* name, uint8_t* data,
      uint32_t data_length, void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  enum EDiscordResult(DISCORD_API* delete_)(
      struct IDiscordStorageManager* manager, const char* name);
  enum EDiscordResult(DISCORD_API* exists)(
...
struct IDiscordVoiceManager {
  enum EDiscordResult(DISCORD_API* get_input_mode)(
      struct IDiscordVoiceManager* manager,
      struct DiscordInputMode* input_mode);
  void(DISCORD_API* set_input_mode)(
      struct IDiscordVoiceManager* manager, struct DiscordInputMode input_mode,
      void* callback_data,
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  enum EDiscordResult(DISCORD_API* is_self_mute)(
      struct IDiscordVoiceManager* manager, bool* mute);
  enum EDiscordResult(DISCORD_API* set_self_mute)(
      struct IDiscordVoiceManager* manager, bool mute);
  enum EDiscordResult(DISCORD_API* is_self_deaf)(
      struct IDiscordVoiceManager* manager, bool* deaf);
  enum EDiscordResult(DISCORD_API* set_self_deaf)(
      struct IDiscordVoiceManager* manager, bool deaf);
  enum EDiscordResult(DISCORD_API* is_local_mute)(
      struct IDiscordVoiceManager* manager, DiscordSnowflake user_id,
      bool* mute);
  enum EDiscordResult(DISCORD_API* set_local_mute)(
      struct IDiscordVoiceManager* manager, DiscordSnowflake user_id,
      bool mute);
  enum EDiscordResult(DISCORD_API* get_local_volume)(
      struct IDiscordVoiceManager* manager, DiscordSnowflake user_id,
      uint8_t* volume);
  enum EDiscordResult(DISCORD_API* set_local_volume)(
      struct IDiscordVoiceManager* manager, DiscordSnowflake user_id,
      uint8_t volume);
};

struct IDiscordAchievementEvents {
  void(DISCORD_API* on_user_achievement_update)(
...
struct IDiscordAchievementManager {
  ...
  void(DISCORD_API* fetch_user_achievements)(
      ...
      void(DISCORD_API* callback)(void* callback_data,
                                  enum EDiscordResult result));
  void(DISCORD_API* count_user_achievements)(
...
struct IDiscordCore {
  ...
  void(DISCORD_API* set_log_hook)(
      struct IDiscordCore* core, enum EDiscordLogLevel min_level,
      void* hook_data,
      void(DISCORD_API* hook)(void* hook_data, enum EDiscordLogLevel level,
                              const char* message));
  struct IDiscordApplicationManager*(DISCORD_API* get_application_manager)(
      struct IDiscordCore* core);
  struct IDiscordUserManager*(DISCORD_API* get_user_manager)(
      struct IDiscordCore* core);
  struct IDiscordImageManager*(DISCORD_API* get_image_manager)(
      struct IDiscordCore* core);
  ...
  struct IDiscordRelationshipManager*(DISCORD_API* get_relationship_manager)(
      struct IDiscordCore* core);
  struct IDiscordLobbyManager*(DISCORD_API* get_lobby_manager)(
      struct IDiscordCore* core);
  struct IDiscordNetworkManager*(DISCORD_API* get_network_manager)(
      struct IDiscordCore* core);
  struct IDiscordOverlayManager*(DISCORD_API* get_overlay_manager)(
      struct IDiscordCore* core);
  struct IDiscordStorageManager*(DISCORD_API* get_storage_manager)(
      struct IDiscordCore* core);
  struct IDiscordStoreManager*(DISCORD_API* get_store_manager)(
      struct IDiscordCore* core);
  struct IDiscordVoiceManager*(DISCORD_API* get_voice_manager)(
      struct IDiscordCore* core);
...
enum EDiscordResult DISCORD_API
