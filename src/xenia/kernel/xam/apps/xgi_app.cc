...
#pragma endregion
    ...
    case 0x000B0010: {
      XELOGI("XSessionCreate({:08X}, {:08X}), implemented in netplay",
...
#pragma endregion
    ...
    case 0x000B0014: {
      ...
      XELOGI("XSessionStart({:08X}), implemented in netplay", buffer_ptr);
      return X_STATUS_SUCCESS;
    }
    case 0x000B0015: {
      // send high scores?
      XELOGI("XSessionEnd({:08X}, {:08X}), implemented in netplay", buffer_ptr,
             buffer_length);
      return X_STATUS_SUCCESS;
    }
    case 0x000B0025: {
